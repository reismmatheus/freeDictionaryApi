...
{
    public class HistoryWordMap : IEntityTypeConfiguration<HistoryWord>
    {
        public void Configure(EntityTypeBuilder<HistoryWord> builder)
        {
            builder.ToTable("TbHistoryWord");
